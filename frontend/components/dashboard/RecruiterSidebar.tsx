...
export default function RecruiterSidebar() {
  ...
  const displayName = user?.name || "Verified Recruiter";
  const displayEmail = user?.email || "recruiter@jobify.com";
  const displayCompany = user?.companyName || "Independent Employer";
